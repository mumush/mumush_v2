...
class UsersController extends AppController {
    ...
    public function edit( $id = null ) {
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            ...
            // //if the user has changed departments
            // if( $this->User->field('department_id') !=  $this->request->data['User']['department_id'] ) {

            //     //find all descriptions that are linked to this user
            //     $descriptions = $this->User->Description->find('all', array( 'conditions' => array('user_id' => $id ) ) );

            //     //for every one of this users descriptions, change the department_id to the new id if it has changed
            //     foreach( $descriptions as $desc ) {

            //         $desc['Description']['department_id'] = $this->request->data['User']['department_id'];
